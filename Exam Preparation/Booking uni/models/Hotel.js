...
const hotelSchema = new Schema({
    name: {type: String, required: true, unique: true, minlength: [4, 'Hotel must at least 4 characters long']},
    city: {type: String, required: true, minlength: [3, 'City must at least 3 characters long']},
